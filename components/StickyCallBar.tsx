...
export function StickyCallBar() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-50 border-t border-orange-700 bg-orange-500 pb-[env(safe-area-inset-bottom)] md:hidden"
      role="region"
      aria-label="24/7 emergency call bar"
    >
      <a
        href={`tel:${business.phoneTel}`}
        className="flex h-12 min-h-12 min-w-12 w-full touch-manipulation items-center justify-center gap-2 px-4 font-display text-lg font-bold uppercase tracking-wide text-white"
